...
void merge_analysis_global_shared_atomic(std::unordered_map<std::string, atomic_counter> ptx_atomic_map, std::unordered_map<std::string, std::vector<branch_counter>> branch_map, std::unordered_map<std::string, std::vector<pc_issue_samples>> pc_stall_map, std::unordered_map<std::string, kernel_metrics> metric_map)
{
...
int main(int argc, char **argv)
{
    ...
    merge_analysis_global_shared_atomic(ptx_atomic_map, branch_map, pc_stall_map, metric_map);
